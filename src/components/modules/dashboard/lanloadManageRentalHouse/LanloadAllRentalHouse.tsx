...
import {
  deleteRentalHouse,
  LanloadGetWonRentalHouse,
} from "@/services/Lanload";
import Image from "next/image";
import Link from "next/link";
import { useEffect, useState } from "react";
import { toast } from "sonner";
          ...
          {paginatedData.map((item: any) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <ul className="box-border flex list-none items-center border-t border-b border-solid border-gray-200 px-0 py-6">
                  <li className="mr-4 flex items-center text-left">
                    <i className="mr-2 text-2xl text-[#151515]">$</i>
                    <span className="text-base">{item.rentAmount}</span>
                  </li>
                ...
                <ul className="m-0 flex list-none items-center justify-between px-0 pt-6 pb-0">
                  ...
                  <li className="text-left">
                    <Link
                      href={`/landlord/dashboard/updatedRentalHouse/${item._id}`}
                    >
                      <Button>Edit</Button>
                    </Link>
                  </li>
          ...
          <div className="flex justify-center mt-10">
            <Pagination>
              <PaginationContent className="flex items-center gap-2">
                <PaginationItem>
                  <PaginationPrevious
                    className="rounded-md bg-black border px-4 py-2 text-white text-sm font-medium hover:bg-[#FF6725] hover:text-black transition"
                    onClick={() =>
                ...
                <PaginationItem>
                  <div className="px-4 py-2 text-sm text-muted-foreground border rounded-md bg-muted/50">
