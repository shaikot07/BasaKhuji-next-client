      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full md:w-1/2 px-4">
            ...
            <div className="flex space-x-4 mb-6">
              <Button onClick={() => setIsModalOpen(true)}>Request Rental</Button>
            </div>
        ...
        House ID: <span className="font-semibold">{homeData?._id || "N/A"}</span>
            ...
            <label className="block mb-2">
              ...
              <input
                ...
                value={rentalRequest.rentalDuration}
                onChange={(e) => setRentalRequest({ ...rentalRequest, rentalDuration: e.target.value })}
              />
            </label>
            ...
            Additional Message:
              <textarea
                ...
                value={rentalRequest.additionalMessage}
                onChange={(e) => setRentalRequest({ ...rentalRequest, additionalMessage: e.target.value })}
              />
            </label>
