import { HelpCircle, HelpCircleIcon, MessageCircle, Phone, } from "lucide-react";
  ...
  return (
    <div className="w-full flex flex-col items-center bg-white text-black">
      <div className="text-center py-16 px-4 max-w-5xl">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 mt-8 text-gray-600 text-sm">
          {/* Email Contact */}
      ...
      <div className="flex flex-col lg:flex-row w-full max-w-7xl px-4 pb-16 gap-8">
