...
const OurTeam = () => {
  return (
    <>
      <NMContainer>
        <h1 className="text-5xl font-bold text-center mt-10 pb-20">
          Our Agents
        </h1>
          ...
          >
            <SwiperSlide>
              <div className="block rounded-lg bg-white shadow-lg dark:bg-danger-700 dark:shadow-black/30 ">
                ...
                <div className="p-6">
                  <h4 className="mb-4 text-2xl font-semibold text-center">Fatima Akter</h4>
                  <hr className="mb-4" />
            ...
            <SwiperSlide>
              <div className="block rounded-lg bg-white shadow-lg dark:bg-neutral-700 dark:shadow-black/30">
                ...
                <div className="p-6">
                  <h4 className="mb-4 text-2xl font-semibold text-center">Sadia Rahman</h4>
                  <hr />
                  <div className="flex items-center justify-center gap-4 mt-2">
                    <a
                      href="https://facebook.com"
            ...
            <SwiperSlide>
              <div className="block rounded-lg bg-white shadow-lg dark:bg-neutral-700 mb-3 dark:shadow-black/30">
                ...
                <div className="p-6">
                  <h4 className="mb-4 text-2xl font-semibold text-center">Maria Smantha</h4>
                  <hr />
                  <div className="flex items-center justify-center gap-4 mt-2">
                    <a
                      href="https://facebook.com"
